...
class Console {
	...
	static determineConsoleFormatMode() {
		if(typeof(window) != "undefined") {
			return 1;
		} else if((typeof process !== "undefined") && (process?.stdout?.isTTY === true)) {
			return 0;
		}
...
class mc2it_$card_CardBuilder {
	static _new() {
		return new StringBuf();
	}
	static center(this1,text) {
		return mc2it_$card_CardBuilder.line(this1,"" + mc2it_$card_CardBuilder.repeat(this1," ",Math.floor((39 - mc2it_$card_CardBuilder.getLength(this1,text)) / 2)) + text);
	}
	static footer(this1) {
		return mc2it_$card_CardBuilder.addLine(this1,"<green>╰" + mc2it_$card_CardBuilder.repeat(this1,"─") + "╯</>");
	}
	static header(this1) {
		return mc2it_$card_CardBuilder.addLine(this1,"<green>╭" + mc2it_$card_CardBuilder.repeat(this1,"─") + "╮</>");
	}
	static label(this1,label,value) {
		return mc2it_$card_CardBuilder.line(this1,StringTools.lpad("<light_white>" + label + ":</> "," ",9 + "   ".length + "<light_white></>".length) + value);
	}
	static line(this1,text) {
		if(text == null) {
			text = "";
		}
		return mc2it_$card_CardBuilder.addLine(this1,"<green>│</>" + text + mc2it_$card_CardBuilder.repeat(this1," ",39 - mc2it_$card_CardBuilder.getLength(this1,text)) + "<green>│</>");
	}
	static addLine(this1,text) {
		this1.b += Std.string("   " + text + mc2it_$card_Program.newLine);
		return this1;
	}
...
class mc2it_$card_Program {
	...
	run(rest) {
		if(this.help || this.version) {
			let v = this.version ? mc2it_$card_Version.get_packageVersion() : new tink_cli_doc_DefaultFormatter().format(tink_cli_Doc0.get());
			process.stdout.write(Std.string(v));
			process.stdout.write("\n");
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(null)));
		}
		let builder = mc2it_$card_CardBuilder.footer(mc2it_$card_CardBuilder.line(mc2it_$card_CardBuilder.label(mc2it_$card_CardBuilder.label(mc2it_$card_CardBuilder.line(mc2it_$card_CardBuilder.label(mc2it_$card_CardBuilder.label(mc2it_$card_CardBuilder.line(mc2it_$card_CardBuilder.center(mc2it_$card_CardBuilder.line(mc2it_$card_CardBuilder.header(mc2it_$card_CardBuilder._new())),"<light_white>MC2IT</> <white>- Distribution & Services</>")),"Card","<yellow>npx</> <white>@mc2it/card</>"),"GitHub","<gray>https://github.com/</><cyan>mc2it</>")),"Email","<white>dev@mc2it.com</>"),"Website","<white>https://www.mc2it.com</>")));
		Console.formatMode = 0;
		Console.logPrefix = "";
		let s = Console.logPrefix + ("" + ("" + mc2it_$card_Program.newLine + Std.string(builder)));
		if(s == null) {
			s = "";
		}
		Console.printFormatted(s + "\n",0);
	...
	static main() {
		new tink_cli_Router0(new mc2it_$card_Program(),new tink_cli_prompt_RetryPrompt(5)).process(process.argv.slice(2)).handle(tink_Cli.exit);
	}
}
mc2it_$card_Program.__name__ = true;
Object.assign(mc2it_$card_Program.prototype, {
	__class__: mc2it_$card_Program
});
class mc2it_$card_Version {
	...
	static get_gitCommitHash() {
		if(mc2it_$card_Version.gitCommitHash == null) {
			mc2it_$card_Version.gitCommitHash = "61187c51958cfb282c6002be507da2081a376ef4";
		}
		return mc2it_$card_Version.gitCommitHash;
	}
	static get_packageVersion() {
		if(mc2it_$card_Version.packageVersion == null) {
			mc2it_$card_Version.packageVersion = "4.0.0";
		}
		return mc2it_$card_Version.packageVersion;
	}
}
mc2it_$card_Version.__name__ = true;
...
class tink_cli_Doc0 {
	static get() {
		if(tink_cli_Doc0.doc == null) {
			tink_cli_Doc0.doc = { doc : " Print the business card of MC2IT, distribution and services. ", commands : [{ isDefault : true, isSub : false, names : [], doc : null}], flags : [{ names : ["--help"], aliases : ["h"], doc : " Output usage information. "},{ names : ["--version"], aliases : ["v"], doc : " Output the version number. "}]};
		}
...
class tink_cli_Router0 extends tink_cli_Router {
	...
	run_run(args) {
		if(args.length < 0) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Insufficient arguments. Expected: " + 0 + ", Got: " + args.length,{ fileName : "src/mc2it_card/Program.hx", lineNumber : 29, className : "tink.cli.Router0", methodName : "run_run"}))));
		}
...
mc2it_$card_CardBuilder.indent = "   ";
mc2it_$card_CardBuilder.width = 39;
mc2it_$card_Program.newLine = Sys.systemName() == "Windows" ? "\r\n" : "\n";
